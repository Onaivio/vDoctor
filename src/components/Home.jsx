...
=======
      ...
      >
        ...
        >
          <Link
            to="/signin"
            class="flex bg-blue-500 items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-blue-600"
          >
            <div class="py-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="#FFF" viewBox="0 0 448 512">
                <path
