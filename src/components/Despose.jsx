...
<<<<<<< HEAD
      ...
      <div className="mb-6">
        <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-2xl">
          ...
          <div className="w-full my-5 p-3 flex flex-col justify-center text-center">
            ...
            <div className="py-3">
                ...
                <div className="text-green-500">
                  ...
                  <div className="flex gap-2 my-2 items-center">
                    <input
                      type="number"
                      id=""
                      className="px-3 py-1.5 text-lg font-normal text-green-500 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-green-600 focus:outline-none"
                      value={metalWaste}
                      onChange={(e) => setMetalWaste(e.target.value)}
                      onKeyUp={calculateTotal}
                    />
                    <p className="text-xl ml-3">
                      EARN {Number(metalWaste) * metalWRate}
                    </p>
                  </div>
                </div>
                <div className="text-green-500">
                  ...
                  <div className="flex gap-2 my-2 items-center">
                    ...
                    />
                    <p className="text-xl ml-3">
                      EARN {Number(plasticWaste) * plasticWRate}
                    </p>
                  </div>
                </div>
                <div className="text-green-500">
                  ...
                  <div className="flex gap-2 my-2 items-center">
                    ...
                    />
                    <p className="text-xl ml-3">
                      EARN {Number(organicWaste) * organicWRate}
                    </p>
                  </div>
                </div>
                <div className="text-green-500">
                  ...
                  <div className="flex gap-2 my-2 items-center">
                    ...
                    />
                    <p className="text-xl ml-3">
                      EARN {Number(organicWaste) * generalWRate}
                    </p>
                  </div>
                </div>
                <div className="text-red-500">
                  ...
                  <div className="flex gap-2 my-2 items-center">
                    <input
                      type="number"
                      id=""
                      className="px-3 py-1.5 text-lg font-normal text-red-500 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-green-600 focus:outline-none"
                      value={nonRMaterialWaste}
                      onChange={(e) => setNRMaterialWaste(e.target.value)}
                      onKeyUp={calculateTotal}
                    />
                    <p className="text-xl ml-3">
                      PAY {Number(nonRMaterialWaste) * NonRWRate}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                {total >= 0 ? (
                  <p className="">
                    TO EARN : <span className="">{total}</span>
                  </p>
                ) : (
                  <p className="">
                    TO PAY : <span className="">{total}</span>
                  </p>
                )}
              </div>
            </div>
            <div className="pt-5 w-full md:w-1/2 mx-auto flex justify-between">
              <a href="./DesposeSent">
                <button className="bg-red-700 text-white font-bold py-2 px-6 hover:bg-red-500 rounded-xl">
                  Cancle
                </button>
              </a>
              <a href="./DesposeSent">
                <button className="bg-green-700 text-white font-bold py-2 px-6 hover:bg-green-500 rounded-xl">
                  Continue
                </button>
              </a>
            </div>
